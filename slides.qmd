...
author: "Dianne Cook <br>Department of Econometrics & Business Statistics <br> Monash University"
date: "2026-06-05"
format:
  revealjs:
    theme: "custom.scss"
...
d_plt1 + geom_text(aes(x = x, y = y, label = v), size=8) 
```
